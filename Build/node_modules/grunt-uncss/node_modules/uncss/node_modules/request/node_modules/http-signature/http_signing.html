...
name followed with an ASCII colon <code>:</code> and an ASCII space ` `.</li>
  <li>If the header name is <code>request-line</code> then appened the HTTP request line,
...
<p>All requests refer to the following request (body ommitted):</p>
...
<pre><code>Authorization: Signature keyId="rsa-key-1",algorithm="rsa-sha256",headers="request-line date content-type content-md5",signature="Base64(RSA-SHA256(signing string))"
</code></pre>
...
<p>The following test data uses the RSA (2048b) keys, which we will refer
...
<pre><code>date: Thu, 05 Jan 2012 21:31:40 GMT
</code></pre>

<p>The Authorization header would be:</p>

<pre><code>Authorization: Signature keyId="Test",algorithm="rsa-sha256",signature="JldXnt8W9t643M2Sce10gqCh/+E7QIYLiI+bSjnFBGCti7s+mPPvOjVb72sbd1FjeOUwPTDpKbrQQORrm+xBYfAwCxF3LBSSzORvyJ5nRFCFxfJ3nlQD6Kdxhw8wrVZX5nSem4A/W3C8qH5uhFTRwF4ruRjh+ENHWuovPgO/HGQ="
</code></pre>
...
<pre><code>Authorization: Signature keyId="Test",algorithm="rsa-sha256",headers="request-line host date content-type content-md5 content-length",signature="Gm7W/r+e90REDpWytALMrft4MqZxCmslOTOvwJX17ViEBA5E65QqvWI0vIH3l/vSsGiaMVmuUgzYsJLYMLcm5dGrv1+a+0fCoUdVKPZWHyImQEqpLkopVwqEH67LVECFBqFTAKlQgBn676zrfXQbb+b/VebAsNUtvQMe6cTjnDY="
</code></pre>
