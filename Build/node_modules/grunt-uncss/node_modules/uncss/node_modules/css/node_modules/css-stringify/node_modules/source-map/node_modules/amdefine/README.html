...
with the braces, it will be stripped out when using the <a href="#optimizer">RequireJS optimizer</a>.</p>
...
<h4>Why distribute AMD-style nodes via npm?</h4>
...
<h4>amdefine/intercept usage</h4>
...
<h4>How amdefine/intercept works</h4>
...
<p>```javascript
define([‘dependency’], function (dependency) {</p>

<p>});
```</p>

<h2>RequireJS optimizer integration. <a name="optimizer">&lt;/name&gt;</a></h2>
