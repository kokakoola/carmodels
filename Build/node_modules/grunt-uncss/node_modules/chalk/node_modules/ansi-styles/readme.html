<h1>ansi-styles <a href="https://travis-ci.org/sindresorhus/ansi-styles"><img src="https://travis-ci.org/sindresorhus/ansi-styles.svg?branch=master" alt="Build Status" /></a></h1>
...
<p>You probably want the higher-level <a href="https://github.com/sindresorhus/chalk">chalk</a> module for styling your strings.</p>
...
<p>```js
var ansi = require(‘ansi-styles’);</p>

<p>console.log(ansi.green.open + ‘Hello world!’ + ansi.green.close);
```</p>
