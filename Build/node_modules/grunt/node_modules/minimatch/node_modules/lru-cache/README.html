...
var LRU = require(“lru-cache”)
  , options = { max: 500
              ...
              , maxAge: 1000 * 60 * 60 }
  , cache = LRU(options)
  , otherCache = LRU(50) // sets just the max size</p>

<p>cache.set(“key”, “value”)
cache.get(“key”) // “value”</p>

<p>cache.reset()    // empty the cache
```</p>
...
to do something like <code>function(n){return n.length}</code>.  The default is
<code>function(n){return 1}</code>, which is fine if you want to store <code>n</code>
like-sized things.</li>
