...
<p><a href="http://travis-ci.org/nodeca/argparse"><img src="https://secure.travis-ci.org/nodeca/argparse.png?branch=master" alt="Build Status" /></a></p>
...
<p><strong>NB.</strong> Method names changed to camelCase. See <a href="http://nodeca.github.com/argparse/">generated docs</a>.</p>
...
<p>```
$ ./test.js -h
usage: example.js [-h] [-v] [-f FOO] [-b BAR]</p>

<p>Argparse example</p>
...
<p><strong>Not supportied yet</strong></p>
...
<p>var subparsers = parser.addSubparsers({
  title:’subcommands’,
  dest:”subcommand_name”
});</p>

<p>var bar = subparsers.addParser(‘c1’, {addHelp:true});
bar.addArgument(
  [ ‘-f’, ‘–foo’ ],
  {
    action: ‘store’,
