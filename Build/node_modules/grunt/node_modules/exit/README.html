<h1>exit <a href="http://travis-ci.org/cowboy/node-exit"><img src="https://secure.travis-ci.org/cowboy/node-exit.png?branch=master" alt="Build Status" /></a></h1>
...
<p>```javascript
var exit = require(‘exit’);</p>

<p>// These lines should appear in the output, EVEN ON WINDOWS.
console.log(“omg”);
console.error(“yay”);</p>
...
<p>// These lines shouldn’t appear in the output.
console.log(“wtf”);
console.error(“bro”);
```</p>

<h2>Don’t believe me? Try it for yourself.</h2>
...
<table>
  <tbody>
    <tr>
      <td>C:\node-exit\test\fixtures&gt;node log-broken.js 0 10 stdout stderr 2&gt;&amp;1</td>
      <td>find “std”</td>
    </tr>
  </tbody>
</table>
