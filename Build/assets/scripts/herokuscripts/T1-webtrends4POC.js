...
// Created: 11/26/2013 8:12:01 AM

	function WebTrends(){
		var that=this;
		// begin: user modifiable
		this.dcsid="dcstthiat00000c9zilmryf99_6e9q";
		this.domain="visitors.toyota-europe.com";
		this.timezone=1;
		this.onsitedoms="";
		...
		this.FPCConfig = {
			...
			name: "WT_FPC",
			domain: "toyotaone.herokuapp.com",
			expires: 63113851500
		};
		this.TPCConfig = {
	...
	if (cmatchCount>0){
		...
		if ((cmatchCount>1)&&(name==this.FPCConfig.name)){
			...
			for (i=0;i<cmatchCount;i++){
				var lv=parseInt(this.dcsGetCrumb(cmatch[i],"lv"),10);
...
WebTrends.prototype.dcsFPC=function(){
	...
	if (document.cookie.indexOf(name+"=")==-1){
		...
		var lv=parseInt(this.dcsGetCrumb(c,"lv"),10);
		var ss=parseInt(this.dcsGetCrumb(c,"ss"),10);
...
WebTrends.prototype.dcsVar=function(){
	...
	var WT=this.WT;
	var DCS=this.DCS;
	WT.tz=parseInt(dCurrent.getTimezoneOffset()/60*-1, 10)||"0";
